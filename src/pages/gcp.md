...
<img src="/portfolio/gcp/Networking_Fundamentals_on_Google_Cloud.png" width="400" height="400" />

VPC networks and load balancers on Google Cloud
...
<img src="/portfolio/gcp/Serverless_Firebase_Development.png" width="400" height="400" />

Build serverless web apps, Import data into a Firestore database, Create a build pipeline with Cloud Build to automate deployments, Build a Google Assistant application.
...
<img src="/portfolio/gcp/Store_Process_and_Manage_Data_on_Google_Cloud_-_Command_Line.png" width="400" height="400" />

Cloud Storage, Cloud Functions, and Cloud Pub/Sub are all Google Cloud Platform services that can be used to store, process, and manage data. All three services can be used together to create a variety of data-driven applications. In this challenge lab you will use Cloud Storage to store images, Cloud Functions to process the images, and Cloud Pub/Sub to send the images to another application.
...
- **[Terraform Fundamentals](https://www.cloudskillsboost.google/focuses/1208?parent=catalog)**
- **[Creating a Streaming Data Pipeline With Apache Kafka](https://www.cloudskillsboost.google/focuses/11809?parent=catalog)**
- **[Getting Started with Redis and RediSearch](https://www.cloudskillsboost.google/focuses/14763?parent=catalog)**
- **[Getting Started with Vault](https://www.cloudskillsboost.google/focuses/31050?parent=catalog)**
...
- **[Dialogflow CX: Bot Building Basics](https://www.cloudskillsboost.google/focuses/20841?parent=catalog)**